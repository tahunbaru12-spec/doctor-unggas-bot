...
def handle_message(message):
    ...
    # 4. Topik Ayam secara umum / Sakit Mata / Telur
    ...
    # 5. Topik Pelbagai Tanaman (Cili, Sayur, Buah, Sawit, Getah, dll)
    elif any(k in teks for k in ["tanaman", "pokok", "sayur", "buah", "baja", "cili", "sawit", "getah", "mangga", "kelapa", "pisang"]):
        balasan = (
            "🌱 **Panduan Pertanian & Tanaman:**\n"
            "1. **Cahaya & Air:** Pastikan tanaman mendapat cahaya matahari penuh dan siraman air yang konsisten.\n"
            ...
            "3. **Kawalan Perosak:** Lakukan semburan cuka kayu atau kawalan organik jika diserang serangga."
        )
    else:
        balasan = (
